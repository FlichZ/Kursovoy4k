...
MEDIA_ROOT = os.path.join(
    BASE_DIR, "media/"
)  # путь в файловой системе по которому хранятся файлы. По умолчанию путь формируется из настроек BASE_DIR (корневая папка проекта) и MEDIA_ROOT
...
STATIC_ROOT = os.path.join(
    BASE_DIR, "static"
)  # тут хранится путь к общей папке static, в кот будут собираться все статич файлы и использоваться на боевом веб сервере-хостинге
...
GRAPH_MODELS = {
    "app_labels": ["custom_admin", "cart", "django_shop", "orders", "shop"],
}
