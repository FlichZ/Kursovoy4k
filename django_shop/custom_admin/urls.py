...
from . import views
from .views import backup_db, restore_db, generate_report, user_list, user_create, user_edit, user_delete
...
urlpatterns = [
    ...
    path('orderitems/delete/<int:id>/', views.orderitem_delete, name='orderitem_delete'),
